            ...
            <div className='left'>
              <div className='box box_shodow'>
                ...
                <div className='details'>
                  ...
                  <p>Phone: +521 3325-60-70-89</p>
                  <p>Email: Carlos.olea.11@gmail.com</p> <br />
                  ...
                  <div className='button f_flex'>
                    ...
                    <a href="https://www.instagram.com/carlos_olea_3/">
                      <button className='btn_shadow'>
                        <i className='fab fa-instagram'></i>
                      </button>
                    </a>
                    <a href="https://twitter.com/Carlos_0lea/with_replies">
                      <button className='btn_shadow'>
